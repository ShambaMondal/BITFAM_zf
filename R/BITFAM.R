...
BITFAM <- function(data, species, interseted_TF = NA, scATAC_obj = NA,ncores, iter = 8000, tol_rel_obj=0.005){
  ...
  print(paste0("17. This is after the scATAC code block: \n", TF_used))
  ...
  print(paste0("22. This is after the chipseq_weight code block: \n", TF_used))
  ...
  print(paste0("29. This is immediately before rstan run: \n", TF_used))
